 ...
 * Conecta con https://parcial1-backend.railway.app/api/authz/usuarios/
 */
...
export const useUsuarios = () => {
  ...
  const cargarUsuarios = useCallback(async () => {
    try {
      ...
      const response = await fetch('https://parcial1-backend.railway.app/api/authz/usuarios/', {
        method: 'GET',
        headers: {
  ...
  const verUsuario = async (id: number): Promise<Usuario | null> => {
    try {
      ...
      const response = await fetch(`https://parcial1-backend.railway.app/api/authz/usuarios/${id}/`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const transferirPropiedad = async (inquilinoId: number): Promise<Usuario> => {
    try {
      ...
      const responseUsuarios = await fetch('https://parcial1-backend.railway.app/api/authz/usuarios/', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      if (propietarioActual && propietarioActual.id !== inquilinoId) {
        ...
        const responseInquilino = await fetch(`https://parcial1-backend.railway.app/api/authz/usuarios/${propietarioActual.id}/`, {
          method: 'PATCH',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
      ...
      const response = await fetch(`https://parcial1-backend.railway.app/api/authz/usuarios/${inquilinoId}/`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const cambiarTipoPersona = async (usuarioId: number, nuevoTipo: 'propietario' | 'inquilino'): Promise<Usuario> => {
    ...
    try {
      ...
      const response = await fetch(`https://parcial1-backend.railway.app/api/authz/usuarios/${usuarioId}/`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
